	...
	extends TestFixture
{
	public $fields =
		...
		, 'code' => ['type' => 'string', 'length' => 2, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null]
		...
		, '_indexes' =>
			[ 'category' => ['type' => 'index', 'columns' => ['category', 'id'], 'length' => []]
			]
		, '_constraints' =>
